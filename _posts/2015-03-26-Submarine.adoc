...
.Sketch rototipo 1
image::http://i.imgur.com/Vstkw7U.png[Submarine, 350, role=left]
.Prototipo 1 listo!
image::http://i.imgur.com/svSLy2z.png[Submarine, 350, role=right]
.Sketch de la nave, prototipo final
image::http://i.imgur.com/raf9FUa.png[Submarine, 350, role=left]
.Nave lista!
image::http://i.imgur.com/HGh8ZPz.png[Submarine, 350, role=right]
.Roca
